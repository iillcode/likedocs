    ...
    <div>
      <header>
        <nav
          ...
          className="group fixed z-20 w-full border-b border-white/10 bg-black/70 backdrop-blur md:relative lg:bg-black/40"
        >
          <div className="m-auto max-w-5xl px-6">
            <div className="flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
              ...
              <div className="group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-white/10 bg-black/80 p-6 shadow-2xl shadow-black/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none">
                  ...
                  <ul className="space-y-6 text-base lg:flex lg:gap-8 lg:space-y-0 lg:text-sm">
                    {menuItems.map((item, index) => (
                      <li key={index}>
                        <Link
                          href={item.href}
                          className="block text-gray-300 duration-150 hover:text-white"
                        >
                          <span>{item.name}</span>
                        </Link>
                      </li>
      ...
      <main>
        <section className="overflow-hidden bg-black text-white">
          ...
          <div className="mx-auto -mt-8 max-w-7xl px-4">
            <div className="relative h-[32rem] overflow-hidden rounded-[--radius] border border-white/10 bg-zinc-900 lg:h-[44rem]">
        ...
        <section className="relative z-10 bg-black py-16">
          <div className="m-auto max-w-5xl px-6">
            ...
            <div className="mx-auto mt-20 flex max-w-4xl flex-wrap items-center justify-center gap-x-12 gap-y-8 sm:gap-x-16 sm:gap-y-12 opacity-80 invert">
              <img
                className="h-5 w-fit"
